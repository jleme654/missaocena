...
public class FListaGarcon extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("Select * from fornecedores where funcao like '%garco%' order by nome desc");
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FListaGarcon().setVisible(true);
            }
        });
    }
